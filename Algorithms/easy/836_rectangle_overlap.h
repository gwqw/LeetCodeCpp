...
public:
    bool isRectangleOverlap(const vector<int>& rec1, const vector<int>& rec2) {
        return 
            inRange(rec1[0], rec1[2], rec2[0], rec2[2]) 
         && inRange(rec1[1], rec1[3], rec2[1], rec2[3]);
    }
private:
    bool inRange(int x11, int x12, int x21, int x22) {
